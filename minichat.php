...
<body class="corps">
    <center>
        ...
        require_once('connect.php');
            $req=$bdd->query('SELECT pseudo, messages, dates, temps FROM minichat ORDER BY ID DESC LIMIT 0, 10');
            ...
            echo '<a href="minichat_2.php"><p class="bas">Voir les messages plus anciens</p></a>';
        ?>
